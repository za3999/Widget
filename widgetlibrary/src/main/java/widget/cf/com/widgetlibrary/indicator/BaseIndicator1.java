...
public abstract class BaseIndicator1<T> extends RecyclerView {
    ...
    public BaseIndicator1(Context context) {
        this(context, null);
    }

    public BaseIndicator1(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public BaseIndicator1(Context context, AttributeSet attrs, int defStyle) {
