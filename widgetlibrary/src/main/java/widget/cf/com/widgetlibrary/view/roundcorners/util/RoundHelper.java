package widget.cf.com.widgetlibrary.view.roundcorners.util;
...
public class RoundHelper {
    ...
    public void setRadius(float radiusDp) {
        ...
        float radiusPx = ApplicationUtil.dp2px(radiusDp);
    ...
    public void setRadius(float radiusTopLeftDp, float radiusTopRightDp, float radiusBottomLeftDp, float radiusBottomRightDp) {
        ...
        mRadiusTopLeft = ApplicationUtil.dp2px(radiusTopLeftDp);
        mRadiusTopRight = ApplicationUtil.dp2px(radiusTopRightDp);
        mRadiusBottomLeft = ApplicationUtil.dp2px(radiusBottomLeftDp);
        mRadiusBottomRight = ApplicationUtil.dp2px(radiusBottomRightDp);
        if (mView != null) {
            mView.invalidate();
        }
    }
    ...
    public void setRadiusTopLeft(float radiusDp) {
        ...
        mRadiusTopLeft = ApplicationUtil.dp2px(radiusDp);
        if (mView != null) {
            mView.invalidate();
        }
    }
    ...
    public void setRadiusTopRight(float radiusDp) {
        ...
        mRadiusTopRight = ApplicationUtil.dp2px(radiusDp);
        if (mView != null) {
            mView.invalidate();
        }
    }
    ...
    public void setRadiusBottomLeft(float radiusDp) {
        ...
        mRadiusBottomLeft = ApplicationUtil.dp2px(radiusDp);
        if (mView != null) {
            mView.invalidate();
        }
    }
    ...
    public void setRadiusBottomRight(float radiusDp) {
        ...
        mRadiusBottomRight = ApplicationUtil.dp2px(radiusDp);
        if (mView != null) {
            mView.invalidate();
        }
    }
    ...
    public void setStrokeWidth(float widthDp) {
        ...
        mStrokeWidth = ApplicationUtil.dp2px(widthDp);
        if (mView != null) {
            setRadius();
